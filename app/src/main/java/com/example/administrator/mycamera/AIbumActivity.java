        ...
        sel=new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                if(x>10&&System.currentTimeMillis()>startTime+1000){
                    ...
                    flipper.setInAnimation(AnimationUtils.loadAnimation(AIbumActivity.this,R.anim.push_right_in));
                    flipper.setInAnimation(AnimationUtils.loadAnimation(AIbumActivity.this,R.anim.push_right_out));
                    flipper.showPrevious();
                }else if(x<-10&&System.currentTimeMillis()>startTime+1000)
                {
                    startTime=System.currentTimeMillis();
                    flipper.setInAnimation(AnimationUtils.loadAnimation(AIbumActivity.this,R.anim.push_left_in));
                    flipper.setInAnimation(AnimationUtils.loadAnimation(AIbumActivity.this,R.anim.push_left_out));
                    flipper.showPrevious();
                }
            }
